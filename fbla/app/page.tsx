...
const page = () => {
  return (
    <div className={"flex flex-col h-screen"}>
      <Header />
      <div className="w-full flex-1 text-center relative flex overflow-hidden">
        ...
        <div className="pt-16 w-full p-10 flex flex-row gap-8 justify-center items-center">
          <div className="w-1/2 h-full flex flex-col justify-center items-center">
            ...
            <h2 className="text-5xl font-bold text-center max-md:text-2xl max-md:p-5 p-12 rounded-full w-full bg-gradient-to-r from-blue-500 to-primary-brand drop-shadow-lg mr-2 hover:scale-[101%] transition-all text-white">
