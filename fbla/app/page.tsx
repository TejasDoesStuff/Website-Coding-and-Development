...
const page = () => {
    return (
        <div className="scroll-smooth">
            <div className="flex flex-col h-screen min-h-[720px] max-md:min-h-[480px]">
                <Header/>
                <section className="h-full">
                    <div className="w-auto flex-1 h-full text-center relative flex overflow-hidden"
                         style={{backgroundImage: "url('/defaults/stem.jpeg')"}}>
                        <Image src="/images/defaults/stem.jpeg" alt="tesla stem" width={256} height={256}
                        ...
                        <div className="pt-16 w-full p-10 flex flex-row gap-8 justify-center items-center">
                            <div className="w-auto md:w-1/2 h-full flex flex-col justify-center items-center">
                                ...
                                <p className="text-md md:text-4xl xl:text-2xl md:w-[96vw] lg:w-auto m-4 mb-0 backdrop-blur-lg p-[5px] rounded-sm">Tesla
                                    STEM's platform for your future.</p>
                                <p className="text-sm md:text-3xl xl:text-xl  md:w-[96vw] lg:w-auto mb-8">By the
                                    Counseling Department</p>
                                <a
                                    href="/signup"
                                ...
                                <a href="#down" className="aspect-square absolute bottom-[5%]"><ArrowDown size={40}
                                                                                                          className="animate-bounce position"/></a>
                            </div>
                        </div>
            ...
            <section className="w-full py-20 px-8 bg-accent text-center text-text" id="down">
                ...
                <div className="flex flex-wrap justify-center gap-8 mt-12">
                    <div
                        className="bg-primary-brand shadow-lg p-6 rounded-lg w-full max-w-sm text-white hover:scale-105 transition-all duration-300">
                    ...
                    <div
                        className="bg-accent-brand shadow-lg p-6 rounded-lg w-full max-w-sm text-white hover:scale-105 transition-all duration-300">
                    ...
                    <div
                        className="bg-secondary-brand shadow-lg p-6 rounded-lg w-full max-w-sm text-white hover:scale-105 transition-all duration-300">
