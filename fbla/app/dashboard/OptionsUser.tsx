...
export default function OptionsUser() {
  ...
  function handleUsernameSubmit() {
    const values = formMethods.getValues(["username"]);
    console.log("Username Values:", values);
  }

  function handlePasswordSubmit() {
    const values = formMethods.getValues(["password"]);
    console.log("Password Values:", values);
  }

  function handleEmailSubmit() {
    const values = formMethods.getValues(["email"]);
    console.log("Email Values:", values);
  }

  function handleProfilePictureSubmit() {
    const values = formMethods.getValues(["profilePicture"]);
    console.log("Profile Picture Values:", values);
  }

  // The functions that are called when the respective form is submitted
        ...
        <div className="w-4/5 h-full flex flex-col absolute right-0 overflow-y-scroll scroll-smooth">
          ...
          <div className="m-16 flex flex-col" id="preferences">
            ...
            <div className="m-6 text-md">
              ...
              <ul>
                <li>
                  Location (Online/In Person - Certain radius from the user's
                  home)
                </li>
